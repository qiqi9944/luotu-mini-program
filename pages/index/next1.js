...
Page({
	...
	onShow: function () {
		app.checkws()
		app.gethistory('首页-'+this.options.typename+'-热点','/pages/index/next1?type='+this.options.type+'&typename='+this.options.typename,1)
		this.getbanner()
		this.getnews()
	},
